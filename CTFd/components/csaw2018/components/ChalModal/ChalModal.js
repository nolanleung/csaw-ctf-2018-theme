...
export default class ChalModal extends React.PureComponent {
  constructor(props) {
    super(props)
            ...
            <div className="chal-content">
              ...
              <div className="chal-row">
                ...
                <div className="chal-files">
                  {challenge.files.map(file => (
                    <a key={file} className="chal-file" href={`/files/${file}`} download>
              ...
              <div className="chal-row">
                <div className="chal-input">
                  ...
                  <div className="chal-input-row">
                    <div className={'chal-response ' + this.classFromResponse(response)}>{response ? response.message : '\u00A0'}</div>
                  </div>
                </div>
              </div>
            </div>
