      ...
      options={[
        {
          label: (
            <span className="icon-span">
              Name <i className="fa fa-sort-alpha-asc" />
            </span>
          ),
          value: 'name_asc',
        },
        {
          label: (
            <span className="icon-span">
              Name <i className="fa fa-sort-alpha-desc" />
            </span>
          ),
          value: 'name_desc',
        },
        {
          label: (
            <span className="icon-span">
              Category <i className="fa fa-sort-alpha-asc" />
            </span>
          ),
          value: 'category_asc',
        },
        {
          label: (
            <span className="icon-span">
              Category <i className="fa fa-sort-alpha-desc" />
            </span>
          ),
          value: 'category_desc',
        },
        {
          label: (
            <span className="icon-span">
              Points <i className="fa fa-sort-numeric-asc" />
            </span>
          ),
          value: 'points_asc',
        },
        {
          label: (
            <span className="icon-span">
              Points <i className="fa fa-sort-numeric-desc" />
            </span>
          ),
          value: 'points_desc',
        },
